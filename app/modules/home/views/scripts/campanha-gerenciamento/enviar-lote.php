<?php include_once dirname(__FILE__).'/../layout/header.php';?>
	...
	<link rel="stylesheet" href="/assets/home/css/datetimepicker-gh/js/bootstrap-material-datetimepicker.css" />
	<script type="text/javascript" src="/assets/home/js/datetimepicker-gh/js/bootstrap-material-datetimepicker.js"></script>
		...
		<div class="box_conteudo">
			...
			<div class="box_adc" id="todas">
				...
				<div class="envio-lote-div">
					...
					<a style="margin-left:0px; margin-bottom:20px;" class="cor_b_hover" onclick="newPeriodo();">Adicionar novo periodo <i class="fa fa-plus-square" style="margin-left:8px;"></i></a>
					...
					<form action="javascript:valida()" method="post">
						...
						<input type="hidden" name="status" value="lotes"/>
						...
						<input type="submit" class="salvar-periodo cor_a_hover" value="Salvar"/>
				...
				<div id="nome-lista" class="celulares" style="text-align:center; display:none;">
					...
					<script>
						...
						function newPeriodo(){
							...
							var periodo  = '<fieldset class="periodo-conta">';
								periodo += '<legend>Periodo <i class="fa fa-times" onclick="delPeriodo(this);"></i></legend>';		
								periodo += '<input required type="text" class="datepicker" name="data[0][]" placeholder="Data">';	
								periodo += '<input required type="text" name="hora_i[0][]" class="horario" placeholder="Hora inicial">';
								periodo += '<input required type="text" name="hora_f[0][]" class="horario" placeholder="Hora final">';
								periodo += '<input required type="text" name="qtdade[0][]" class="qtdade" onchange="validaTotal();" placeholder="Qtde sms">';	
								periodo += '</fieldset>';					

							$('.envio-lote-div').prepend(periodo);
							...
							$('.horario').bootstrapMaterialDatePicker({ 
								date: false,
								format : 'HH:mm'
							});
						...
						function valida(){
							...
							var conta2 = parseInt(max_contatos) - parseInt(total_periodos);

							if ( !total_periodos ){
								total_periodos = 0
							}
							
							console.log( parseInt(total_periodos), parseInt(max_contatos) )
							...
							} else if (parseInt(total_periodos) < parseInt(max_contatos)){
								alert('Você selecionou uma quantidade de contatos menor que a sua lista, aumente '+conta2+' contatos entre os periodos para avançar.');
							} else {
