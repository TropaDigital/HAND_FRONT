			...
			<div class="box_adc" id="todas">
				...
				<div class="envio-lote-div">
					...
					<form action="javascript:valida()" method="post">
						...
						<input type="submit" class="salvar-periodo cor_a_hover" value="Agendar"/>
					...
					<script>
						...
						function newPeriodo(){
							...
							var periodo  = '<fieldset class="periodo-conta">';
								periodo += '<legend>Periodo <i style="display:none;" class="fa fa-times" onclick="delPeriodo(this);"></i></legend>';		
								...
								periodo += '<input required type="hidden" name="qtdade[0][]" value="<?php echo $this->totalContatos;?>" class="qtdade" onchange="validaTotal();" placeholder="Qtde sms">';	
								periodo += '</fieldset>';					

							$('.envio-lote-div form').prepend(periodo);
