			...
			<div class="box_adc">
				...
				<div class="filtro-pag">
					<form class="filter">
						...
						<input name="mensagem" placeholder="Mensagem" type="text" value="<?php echo $_GET['mensagem']?>"/>
						
						<input name="celular" placeholder="Celular" type="text" value="<?php echo $_GET['celular']?>"/>
					...
					<table style="border-radius:0px;">
						...
						<?php } else { ?>
							...
							<tr>
								...
								<td><a href="javascript:relatorioCampanha(<?php echo $row->id_campanha;?>);"><?php echo $row->campanha;?></a></td>
								<td><?php echo $row->mensagem; ?></td>
								<td><?php echo $row->linha;?></td>
								<td><?php echo str_replace('-', '/', date('d-m-Y H:i', strtotime( $row->data_lote ) ) );?></td>
