...
<head>
	...
	<meta charset="UTF-8">
	<title>Vendedor <?php echo $this->me->gCores->nome == NULL ? '' : '- '.$this->me->gCores->nome;?></title>
    ...
    <?php 
		...
		array_push($cores, array(
				'indice'=>'a',
				'bg'=>$this->me->gCores->cor_a,
				'bg_hover'=>$this->me->gCores->cor_a_hover,
				'color'=>$this->me->gCores->cor_a_font,
				'color_hover'=>$this->me->gCores->cor_a_font_hover
			)
		);
		
		array_push($cores, array(
				'indice'=>'b',
				'bg'=>$this->me->gCores->cor_b,
				'bg_hover'=>$this->me->gCores->cor_b_hover,
				'color'=>$this->me->gCores->cor_b_font,
				'color_hover'=>$this->me->gCores->cor_b_font_hover
			)
		);
		
		array_push($cores, array(
				'indice'=>'c',
				'bg'=>$this->me->gCores->cor_c,
				'bg_hover'=>$this->me->gCores->cor_c_hover,
				'color'=>$this->me->gCores->cor_c_font,
				'color_hover'=>$this->me->gCores->cor_c_font_hover
			)
		);
