		...
		<div class="filtro-pag">
			<form class="filter">
				...
				<select name="id_usuario" onchange="javascript:$(this).parent().submit();">
					...
					<option <?php echo $_GET['id_usuario'] == $row->id_usuario ? 'selected' : ''; ?> value="<?php echo $row->id_usuario;?>"><?php echo $this->me->nivel == 5 ? $row->gerenciador.' - ' : ''; echo $row->name_user;?></option>
					<?php } ?>
				</select>
				...
				<select name="status" onchange="javascript:$(this).parent().submit();">
					...
					<option <?php echo $_GET['status'] == 'REJECTED' ? 'selected' : ''; ?> value="REJECTED"><?php echo $this->lg->_("Não aberto"); ?></option>
					<option <?php echo $_GET['status'] == 'ERROR' ? 'selected' : ''; ?> value="ERROR"><?php echo $this->lg->_("Erro ao enviar"); ?></option>
				</select>
		...
		<div class="listagem">
			...
			<table style="border-radius:0px;">
				...
				<tr>
					...
					<?php if ( $this->me->nivel == 5 ){?>
						<th><?php echo $this->lg->_("Whitelabel"); ?></th>
					<?php } ?>
					
					<th><?php echo $this->lg->_("Cliente"); ?></th>
				...
				<?php } else { ?>
					...
					<tr>
						...
						<?php if ( $this->me->nivel == 5 ){?>
    						<td>
    							<?php echo $this->me->familia[$row->id_usuario]->gerenciador; ?><br/>
    						</td>
    					<?php } ?>
					
						<td>
							<?php echo $this->me->familia[$row->id_usuario]->name_user; ?><br/>
						</td>
						<td>
