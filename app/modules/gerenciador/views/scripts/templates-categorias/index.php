	...
	<div id="central">
		...
		<form action="/<?php echo $this->baseModule;?>/<?php echo $this->baseController; ?>/excluir" method="post">
			...
			<table class="table-edicao">
				...
				<tr>
					<td>
						<input type="checkbox" name="id[]" value="<?php echo $row->id_categoria;?>"/>
					</td>
					<td>
						<a href="/<?php echo $this->baseModule;?>/<?php echo $this->baseController;?>/editar/id/<?php echo $row->id_categoria; ?>"><i class="pe-7s-pen" ></i> EDITAR</a>
					</td>
					<td><?php echo $row->categoria; ?></td>
					<td>
                        <img src="<?php echo $row->imagem; ?>" style="max-width: 40px; max-height: 40px"/>
                    </td>
				</tr>
				<?php } ?>
			</table>
