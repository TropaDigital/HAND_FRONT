...
class Gerenciador_VendedoresController extends My_Controller 
{
	...
	public function ini()
	{
		...
		$this->dbVendedores->_required(array('id_vendedor', 'id_gerenciador_criado', 'vendedor','modificado','criado'));
    ...
    public function actionAction ()
    {
    	...
    	$post['nivel'] = 6;
    	$post['ativo'] = 1;
    	$post['id_gerenciador_criado'] = $this->me->id_usuario;
