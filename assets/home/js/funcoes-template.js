$(function(){
	...
	$(document).on('click', '.termos-accept .text-accept a', function(){

		var mae = $('.termos-accept')
		mae.toggleClass('opened')
		mae.find('.texto-termos').after('<a class="back-terms">Voltar</a>')

	})

	$(document).on('click', '.back-terms', function(){

		$('.back-terms').remove()
		$('.termos-accept').removeClass('opened')

	})

	$('.drop-drops form, #landing-page form').on('submit', function () {
